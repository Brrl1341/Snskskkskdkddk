...
Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "الالماني")
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ الالماني ماعندها حساب بالبنك ","md",true)  
return false
end
...
send("-1001725819460",0,"⇜ الايدي ↤ "..msg.sender_id.user_id.."\n⇜ الجروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
...
if text and text:match('^استثمار (.*)$') then
    ...
    local coniss
    if UserName == "فلوسي" then
        coniss = tonumber(ballanceed)
    else
        coniss = coin(UserName)
    end
...
send(msg.chat_id,msg.id, "⇜ حوالة صادرة من بنك الالماني\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المستلم ↤ "..newss.."\n⇜ الحساب رقم ↤ `"..text.."`\n⇜ نوع البطاقة ↤ "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ ↤ "..convert_mony.." جنيه 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك الالماني\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المبلغ ↤ "..convert_mony.." جنيه 💵","md",true)
Redis:del(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheMero.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
local toptop = "⇜ أهلين يا روح الالماني هذي أوامري :\n⇜ اختر نوع التوب من الازرار\n\n⇜ تتصفر اللعبة بعد ↤ "..day.."\n✧"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local nadebott = {"اشبيلية", "ريفر بلايت", "ريفر بلايت", "بوروسيا", "أياكس الهولندي", "ليون", "شاختار دونيتسك", "روما", "فياجنيه", "بوكا جونيورز", "نابولي", "بنفيكا", "فلامنجو", "ليستر سيتي", "بالمرسي", "ليل", "جنيه سوسيداد", "ايندهوفن", "الأهلي المصري", "الهلال السعودي", "الاتحاد السعودي",}
...
if Redis:sismember(TheMero.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة الالماني :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 جنيه 💵\n- بندوره : 100 جنيه 💵\n- خس : 125 جنيه 💵\n- خيار : 150 جنيه 💵\n- جزر : 175 جنيه 💵\n- فليفله : 200 جنيه 💵\n- فريز : 300 جنيه 💵\n- ذره : 400 جنيه 💵\n- ثوم : 500 جنيه 💵\n- فطر : 800 جنيه 💵\n- شجره تفاح : 1000 جنيه 💵\n- شجره عنب : 1250 جنيه 💵\n-شجره زيتون : 1500 جنيه 💵\n- شجره موز : 2000 جنيه 💵\n- شجره مانجا : 3000 جنيه 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
ballanceed = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) > 1000000001 then
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح هو مليار جنيه 💵\n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 جنيه 💵\n✧","md",true)
end
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ الالماني ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(TheMero.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
