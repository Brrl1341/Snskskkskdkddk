...
send(chat_id,0,"\n*⇜ هذه الجروب محظور سوف اغادر جاوو*","md",true)  
...
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('𖦹 هذه اللويسه ليست لك 𖦹')..'&show_alert=true')
end
end
end
...
local input_message_content = {message_text = 'هذي اللويسة للحلو ( [@'..username[2]..'] )\nهو اللي يقدر يشوفها 📧', parse_mode = 'Markdown'}	
local reply_markup = {inline_keyboard={{{text = 'لرؤية اللويسة', callback_data = '/Hmsa1@'..data.sender_user_id..'@'..UserId_Info.id..'/'..idnum}}}}	
local resuult = {{type = 'article', id = idnum, title = 'هذه لويسه سرية الى [@'..username[2]..']', input_message_content = input_message_content, reply_markup = reply_markup}}	
...
if tonumber(msg.sender_id.user_id) == 1486460019 then
msg.Name_Controller = 'مبرمج البوت'
msg.The_Controller = 1
elseif tonumber(msg.sender_id.user_id) == 1486460019 then
...
{
{text = 'غامبول', url = 't.me/gumball_free'}, 
},
}
}
...
data = {
{
{text = 'لرؤية اللويسة', data = "sender:"..anubis[1].."to:"..to_id.."hmsa:"..anubis[2]
}
},
}
}
send(chat_id,msg_id,"⇜ ياحلو 「 ["..to_name.."](tg://user?id="..to_id..") 」\n⇜ لديك لويسة سرية من「 ["..sender_name.."](tg://user?id="..anubis[1]..") 」\n⇜ انت فقط من يستطيع رؤيتها","md",true,false,false,false,reply_markup)
edit(ChatId,Msg_id,"⇜ تم ارسال اللويسة", 'md',false)
...
if tonumber(GetUserReply) == 1486460019 then
testser = true
elseif tonumber(GetUserReply) == 1486460019 then
testser = true
...
msalm = "⇜ وسوينا لك حساب في بنك الالماني\n⇜ وشحنالك ٥٠ ريال 💸 هديه\n\n⇜ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n⇜ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n⇜ فلوسك ↤ ❲ 50 ريال 💸 ❳\n⇜ شخصيتك ↤ "..shakseshakse.."\n⇜ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
msalm = "⇜ عملنالك  حساب في بنك الالماني\n⇜ وشحنالك ٥٠ جنيه 💸 هديه\n\n⇜ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n⇜ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n⇜ فلوسك ↤ ❲ 50 ريال 💸 ❳\n⇜ شخصيتك ↤ "..shakseshakse.."\n⇜ دولتك ↤ ❲ 🇮🇶 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
edit(tonumber(UserId[3]),Msg_id,'⇜ تم مسح الرسالة من الجروب', 'md', true)
end
end
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الجروب لعدم تنفيذه العقاب").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
data = {
{{text = 'غامبول', url = 't.me/gumball_free'},},}}
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الجروب").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('هذا الامر للمشاركين في لعبة العقاب')..'&show_alert=true')
end
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الجروب لعدم تنفيذه الاحكام").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الجروب لعدم تنفذه الاحكام").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
local TextHelp = Reply_Status(kk_id,"⇜ تم الغاء كتمه في الجروب").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('هذا الامر للفائز بلعبة الاحكام')..'&show_alert=true')
end
...
⌯ Master* [الاخضر](T.me/E1arg) | [احمد](T.me/K5kil)
]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
⌯ انشاء حساب بنكي  ↢ تنشئ حساب وتقدر تحول فلوس مع مزايا ثانيه

⌯ مسح حساب بنكي  ↢ تمسح حسابك البنكي

⌯ تحويل ↢ تطلب رقم حساب الشخص وتحول له فلوس

⌯ حسابي  ↢ يطلع لك رقم حسابك عشان تديه للشخص اللي بيحول لك

⌯ فلوسي ↢ يقولك كم فلوسك

⌯ راتب ↢ يديلك راتب كل ١٠ دقائق

⌯ بخشيش ↢ يديلك بخشيش كل ١٠ دقايق
...
⌯ كنز ↢ يديلك كنز بسعر مختلف انتا وحظك
