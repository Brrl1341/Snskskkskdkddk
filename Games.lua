...
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم في الجروب')
...
local list = {
            ...
            "وش اسم جروبك انت واصحابك المقربين ؟",
            "وش اسم جروب عائلتك فالواتس اب ؟",
...
if not data.id then
send(msg_chat_id,msg_id,'⇜ لا يوجد جروب في البوت بهذا الايدي')
return false
end
...
"لو خيروك |  بين أن تتكلم باللويس فقط طوال الوقت أو أن تصرخ فقط طوال الوقت؟ ",
...
katu = {
"*روح الى اي جروب عندك واكتب اي شيء يطلبه منك اللاعبين الحد الاقصى 3 رسائل*.",
...
keyboard.inline_keyboard = {
{
{text = 'غامبول', url = "https://t.me/gumball_free"}
},
}
